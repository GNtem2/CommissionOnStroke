...
```
```{r FixCountryNames, warning=FALSE, message=FALSE, echo=FALSE, results='hide'}

```
```{r Map1, warning=FALSE, message=FALSE, echo=FALSE, results='hide', cache=TRUE}

```
```{r Map2, warning=FALSE, message=FALSE, echo=FALSE, results='hide', cache=TRUE}

```
```{r, SaveMaps, warning=FALSE, message=FALSE, echo=FALSE, results='hide', cache=TRUE}
